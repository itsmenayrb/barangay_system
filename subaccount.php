<?php include 'header.php'; ?>
    ...
    <?php } else { ?>
    	<?php
		    ...
		    <?php } else { ?>
		    	<?php
		    		$autoID = checkInput($_GET['update']);
					$sql = "SELECT * FROM subusers WHERE id ='".$autoID."'" . "AND username = '".$current."'";
						    	...
						    	<div class="card border-info" style="margin-bottom: 10px;">
						    		...
						    		<div class="card-body">
						    			<form action="subaccount.php" id="subaccountForm" method="post" style="width: 70%; margin: 0 auto;" autocomplete="off">
									        <?php include 'includes/errors.inc.php'; ?>
									        <?php include 'includes/success.inc.php';?>
									        <input type='hidden' name='hiddenSubAccountUpdateId' value='<?php echo $_GET['update'];?>'/>
									        <div class="form-group">
									        	<label for="relationship">Relationship</label>
										        <select class="form-control" name="relationship" id="relationship" onchange="checkRelationship(this.value);">
										        	<option value="" selected="selected">(Please Choose One)</option>
								            ...
								            <div class="row">
								                ...
								                <div class="form-group col-md-4">
								                    <label for="fname">First Name</label>
								                    <input type="text" class="form-control" value="<?php echo $row['fname']; ?>" name="fname" id="reg-fname" placeholder="Juan" required/>
								                </div>
								                <div class="form-group col-md-3">
								                    <label for="mname">Middle Name</label>
								                    <input type="text" class="form-control" value="<?php echo $row['mname']; ?>" name="mname" id="reg-mname" placeholder="Dela" />
								                </div>
								                <div class="form-group col-md-3">
								                    <label for="lname">Last Name</label>
								                    <input type="text" class="form-control" value="<?php echo $row['lname']; ?>" name="lname" id="reg-lname" placeholder="Cruz" required/>
								                </div>
								            </div>
								            <div class="row">
								                <div class="form-group col-md-3">
								                ...
								                <div class="col-md-6">
								                    <div class="form-group">
								                        <label for="birthday">Birthdate</label>
								                        <input type="text" class="form-control" value="<?php echo $row['birthday']; ?>" id="reg-birthday" name="birthday" required/>
								                    </div>
								                </div>
								                <div class="col-md-3">
								                    <div class="form-group">
								                        <label for="age">Age</label>
								                        <input type="text" id="reg-age" name="age" value="<?php echo $row['age']; ?>" class="form-control" readonly/>
								                    </div>
								                </div>
								            </div>
								            <div class="form-group">
								            ...
								            <div class="row">
										        ...
										        <div class="col-md-6">
										            <input type="submit" name="updateRelationshipBtn" class="form-control btn btn-warning" value="Update" />
										        </div>
								        	</div>
									    </form>
						    		</div> <!-- end of card body -->
